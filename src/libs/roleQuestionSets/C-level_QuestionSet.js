...
const CAE_QSet = [
    ...
    new QuestionObj({
        questionSet: {
            English: 'How do you consider the move from your current SAP version to S/4HANA?',
        ...
        answerSet: {
            English: [
                'We are not considering moving to S/4HANA on-premise or Cloud',
    ...
    new QuestionObj({
        questionSet: {
            English: 'What are the risks of running  SAP on a hyperscaler*?',
